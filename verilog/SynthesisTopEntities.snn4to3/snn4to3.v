...
module snn4to3
  ...
  reg [95:0] neuronStates = {32'sd0,   32'sd0,   32'sd0};
  wire [98:0] results;
  wire [3:0] eta;
  wire [383:0] c$vec;
  wire [98:0] neuronStates_1;
  ...
  always @(posedge clk or  posedge  rst) begin : neuronStates_register
    if ( rst) begin
      neuronStates <= {32'sd0,   32'sd0,   32'sd0};
    end else if (en) begin
      neuronStates <= neuronStates_1[98:3];
    end
  end
  // register end
  ...
  for (i_4 = 0; i_4 < 3; i_4 = i_4 + 1) begin : zipWith_1
    ...
    assign c$bv_3 = (($unsigned(result_10)));
    ...
    assign r_0 = result_10 + zipWith_in2_1;

    assign fired = result_9 >= 32'sd65536;

    assign c$app_arg_1 = fired ? 32'sd0 : result_9;

    assign c$bv_5 = (rR >> (64'sd16));

    assign result_10 = (((~ (| (c$app_arg_2))) | (& (c$app_arg_2))) == 1'b1) ? ($signed((c$bv_5[0+:32]))) : c$case_alt_5;
