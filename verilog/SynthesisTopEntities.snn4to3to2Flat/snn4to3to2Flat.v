...
module snn4to3to2Flat
  ...
  // /Users/jake/EMPIRE/projects/ongoing/2026_039/CategoricalSNN.hs/synthesis/TopEntities.hs:129:1-14
  ...
  genvar i_4;
  generate
  for (i_4=0; i_4 < 2; i_4 = i_4 + 1) begin : map_0
    wire [95:0] map_in_0;
    ...
    assign c$vec2_0 = (ws1_1[128-1 : 32]);

    // zipWith start
    genvar i_2;

    for (i_2 = 0; i_2 < 3; i_2 = i_2 + 1) begin : zipWith_1
    ...
    for (i_3 = 0; i_3 < 3; i_3 = i_3 + 1) begin : zipWith_2
  ...
  genvar i_5;
  generate
  for (i_5=0; i_5 < 3; i_5 = i_5 + 1) begin : map_1
    wire [32:0] map_in_1;
    ...
    assign c$ds_app_arg_4[i_5*32+:32] = map_out_1;
  end
  endgenerate
  // map end
  ...
  for (i_6=0; i_6 < 2; i_6 = i_6 + 1) begin : map_2
    ...
    assign c$ds_app_arg_5[i_6*32+:32] = map_out_2;
  end
  endgenerate
  // map end
  ...
  always @(posedge clk or  posedge  rst) begin : ds_register
    if ( rst) begin
      ...
      ds <= {c$ds_app_arg_4,   c$ds_app_arg_5};
    end
  end
  // register end
  ...
  genvar i_8;
  generate
  for (i_8=0; i_8 < 3; i_8 = i_8 + 1) begin : map_4
    wire [32:0] map_in_4;
  ...
  assign c$ds_app_arg_0 = c$ds_app_arg[1:1];

  assign c$ds_app_arg_1 = c$ds_app_arg[0:0];
